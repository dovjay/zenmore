export default function NewsSlider() {
  return <div className="absolute right-8 mt-32 bg-black/75 h-10 w-fit rounded-full flex items-center px-6 py-2 border-2 border-white/50">
    ...
    <div 
      ...
      className="ml-3 overflow-hidden w-96"
    >
