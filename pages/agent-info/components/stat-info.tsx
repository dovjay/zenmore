...
export default function StatInfo(props: IStatInfo) {
  ...
  if (empty) {
    return <div className="bg-black flex gap-4 text-white/20 text-2xl font-bold px-6 py-1 rounded-full items-center">
  ...
  return <div className="bg-black flex text-white text-2xl font-bold px-6 py-1 rounded-full">
    <span>{statName}</span>
